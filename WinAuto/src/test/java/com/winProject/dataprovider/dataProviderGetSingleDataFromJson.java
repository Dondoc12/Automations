...
import com.WinUIAutomation.helpers.WinAppJsonHelpers;
import com.WinUIAutomation.utils.WinAppJsonUtils;
...
public final class dataProviderGetSingleDataFromJson {
    ...
    public static Object[][] getConfigJsonData() {
        String data1 = WinAppJsonUtils.get("test1");
        String data2 = WinAppJsonUtils.get("test2");
        String data3 = WinAppJsonUtils.get("test3");
    ...
    public static Object[][] getFileJsonData() {
        WinAppJsonHelpers jsonHelpers = new WinAppJsonHelpers();
