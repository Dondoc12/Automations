...
public class WinAppCaptureHelpers extends ScreenRecorder {
    ...
    //Hàm xây dựng
    public WinAppCaptureHelpers(GraphicsConfiguration cfg, Rectangle captureArea, Format fileFormat, Format screenFormat, Format mouseFormat, Format audioFormat, File movieFolder, String name) throws IOException, AWTException {
    ...
    public static void startRecord(String methodName) {
        ...
        File file = new File("./" + WinAppConstants.EXPORT_VIDEO_PATH + "/" + methodName + "/");
    ...
    public static void captureScreenshot(WebDriver driver, String screenName) {
        try {
            ...
            WinAppLogUtils.info("Driver for Screenshot: " + driver);
            ...
            WinAppLogUtils.info("Screenshot taken current URL: " + driver.getCurrentUrl());
        } catch (Exception e) {
    ...
    public static File getScreenshotFile(String screenshotName) {
        ...
        String path = WinAppHelpers.getCurrentDir() + WinAppConstants.EXTENT_REPORT_FOLDER + File.separator + "images";
        File folder = new File(path);
        if (!folder.exists()) {
            folder.mkdir();
            WinAppLogUtils.info("Folder created: " + folder);
        }
    ...
    public static String getScreenshotRelativePath(String screenshotName) {
        ...
        String filePathRelative = WinAppConstants.EXTENT_REPORT_FOLDER + File.separator + "images" + File.separator + screenshotName + dateName + ".png";
