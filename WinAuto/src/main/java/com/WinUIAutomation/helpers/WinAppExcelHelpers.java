...
import com.WinUIAutomation.exceptions.WinAppWinAppInvalidPathForExcelWinAppException;
...
public class WinAppExcelHelpers {
    ...
    public WinAppExcelHelpers() {
    }

    //Set Excel File
    public void setExcelFile(String excelPath, String sheetName) {
        WinAppLogUtils.info("Set Excel File: " + excelPath);
        WinAppLogUtils.info("Sheet Name: " + sheetName);
        ...
        try {
            ...
            if (!f.exists()) {
                try {
                    WinAppLogUtils.info("File Excel path not found.");
                    throw new WinAppWinAppInvalidPathForExcelWinAppException("File Excel path not found.");
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
            if (sheetName.isEmpty()) {
                try {
                    WinAppLogUtils.info("The Sheet Name is empty.");
                    throw new WinAppWinAppInvalidPathForExcelWinAppException("The Sheet Name is empty.");
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
            ...
            if (sheet == null) {
                ...
                try {
                    WinAppLogUtils.info("Sheet name not found.");
                    throw new WinAppWinAppInvalidPathForExcelWinAppException("Sheet name not found.");
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
    ...
    public Object[][] getExcelData(String excelPath, String sheetName) {
        ...
        WinAppLogUtils.info("Set Excel file " + excelPath);
        WinAppLogUtils.info("Selected Sheet: " + sheetName);
    ...
    public Object[][] getDataHashTable(String excelPath, String sheetName, int startRow, int endRow) {
        WinAppLogUtils.info("Excel File: " + excelPath);
        WinAppLogUtils.info("Sheet Name: " + sheetName);
        ...
        try {
            ...
            WinAppLogUtils.info("Row: " + rows + " - Column: " + columns);
            WinAppLogUtils.info("StartRow: " + startRow + " - EndRow: " + endRow);
