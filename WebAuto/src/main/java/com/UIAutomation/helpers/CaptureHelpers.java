...
public class CaptureHelpers extends ScreenRecorder {
    ...
    public static void startRecord(String methodName) {
        ...
        File file = new File("./" + Constants.EXPORT_VIDEO_PATH + "/" + methodName + "/");
    ...
    public static File getScreenshotFile(String screenshotName) {
        ...
        String path = Helpers.getCurrentDir() + Constants.EXTENT_REPORT_FOLDER + File.separator + "images";
    ...
    public static String getScreenshotRelativePath(String screenshotName) {
        ...
        String filePathRelative = Constants.EXTENT_REPORT_FOLDER + File.separator + "images" + File.separator + screenshotName + dateName + ".png";
