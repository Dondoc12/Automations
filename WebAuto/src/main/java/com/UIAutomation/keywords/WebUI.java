...
public class WebUI {
    ...
    public static void addScreenshotToReport(String screenName) {
        if (Constants.SCREENSHOT_ALL_STEPS.equals(Constants.YES)) {
            if (ExtentTestManagement.getExtentTest() != null) {
                ExtentReportManagement.addScreenShot(Helpers.makeSlug(screenName));
            }
    ...
    public static void takeFullPageScreenshot(String screenName) {
        ...
        try {
            ...
            LogUtils.info("Driver for Screenshot: " + DriverManagement.getDriver());
            // Create reference of TakesScreenshot
            TakesScreenshot ts = (TakesScreenshot) DriverManagement.getDriver();
    ...
    public static void getToUrlAuthentication(String url, String username, String password) {
        ...
        DevTools devTools = ((HasDevTools) DriverManagement.getDriver()).getDevTools();
    ...
    public static void setWindowSize(int widthPixel, int heightPixel) {
        DriverManagement.getDriver().manage().window().setSize(new Dimension(widthPixel, heightPixel));
    }
    ...
    public static void setWindowPosition(int X, int Y) {
        DriverManagement.getDriver().manage().window().setPosition(new Point(X, Y));
    }
    ...
    public static void minimizeWindow() {
        DriverManagement.getDriver().manage().window().minimize();
    }
    ...
    public static String printPage(int endPage) {
        ...
        Pdf pdf = ((PrintsPage) DriverManagement.getDriver()).print(printOptions);
    ...
    public static WebElement getWebElement(By by) {
        return DriverManagement.getDriver().findElement(by);
    }
    ...
    public static List<WebElement> getWebElements(By by) {
        return DriverManagement.getDriver().findElements(by);
    }
    ...
    public static void uploadFileWithLocalForm(By by, String filePath) {
        ...
        if (ExtentTestManagement.getExtentTest() != null) {
            ExtentReportManagement.info("Upload File with Local Form: " + filePath);
        }
    }
    ...
    public static void uploadFileWithSendKeys(By by, String filePath) {
        ...
        if (ExtentTestManagement.getExtentTest() != null) {
            ExtentReportManagement.info("Upload File with SendKeys");
        }
    }
    ...
    public static String getCurrentUrl() {
        smartWait();
        LogUtils.info("Get Current URL: " + DriverManagement.getDriver().getCurrentUrl());
        if (ExtentTestManagement.getExtentTest() != null) {
            ExtentReportManagement.info("Get Current URL: " + DriverManagement.getDriver().getCurrentUrl());
        }
        return DriverManagement.getDriver().getCurrentUrl();
    }
    ...
    public static String getPageTitle() {
        ...
        LogUtils.info("Get Page Title: " + DriverManagement.getDriver().getTitle());
        if (ExtentTestManagement.getExtentTest() != null) {
            ExtentReportManagement.info("Get Page Title: " + DriverManagement.getDriver().getTitle());
        }
        return title;
    }
    ...
    public static boolean verifyPageContainsText(String text) {
        smartWait();
        return DriverManagement.getDriver().getPageSource().contains(text);
    }
    ...
    public static void switchToFrameByIndex(int index) {
        ...
        WebDriverWait wait = new WebDriverWait(DriverManagement.getDriver(), Duration.ofSeconds(Constants.WAIT_EXPLICIT), Duration.ofMillis(500));
    ...
    public static void switchToDefaultContent() {
        ...
        DriverManagement.getDriver().switchTo().defaultContent();
    ...
    public static void switchToWindowOrTabByPosition(int position) {
        ...
        DriverManagement.getDriver().switchTo().window(DriverManagement.getDriver().getWindowHandles().toArray()[position].toString());
    ...
    public static void switchToWindowOrTabByTitle(String title) {
        ...
        String originalWindow = DriverManagement.getDriver().getWindowHandle();
        ...
        for (String windowHandle : DriverManagement.getDriver().getWindowHandles()) {
            if (!originalWindow.contentEquals(windowHandle)) {
                DriverManagement.getDriver().switchTo().window(windowHandle);
                if (DriverManagement.getDriver().getTitle().equals(title)) {
                    break;
                }
            }
        }
    ...
    public static void switchToWindowOrTabByUrl(String url) {
        ...
        for (String windowHandle : DriverManagement.getDriver().getWindowHandles()) {
            if (!originalWindow.contentEquals(windowHandle)) {
                DriverManagement.getDriver().switchTo().window(windowHandle);
                if (DriverManagement.getDriver().getCurrentUrl().equals(url)) {
                    break;
                }
            }
        }
    ...
    public static void closeCurrentWindow() {
        ...
        DriverManagement.getDriver().close();
    ...
    public static boolean verifyTotalOfWindowsOrTab(int number) {
        return new WebDriverWait(DriverManagement.getDriver(), Duration.ofSeconds(Constants.WAIT_EXPLICIT)).until(ExpectedConditions.numberOfWindowsToBe(number));
    }
    ...
    public static void openNewTab() {
        ...
        DriverManagement.getDriver().switchTo().newWindow(WindowType.TAB);
    ...
    public static void openNewWindow() {
        ...
        DriverManagement.getDriver().switchTo().newWindow(WindowType.WINDOW);
    ...
    public static void switchToMainWindow() {
        smartWait();
        DriverManagement.getDriver().switchTo().window(DriverManagement.getDriver().getWindowHandles().toArray()[0].toString());
        LogUtils.info("Switch to Main Window." + DriverManagement.getDriver());
    }
    ...
    public static void switchToMainWindow(String originalWindow) {
        smartWait();
        DriverManagement.getDriver().switchTo().window(originalWindow);
    ...
    public static void switchToLastWindow() {
        smartWait();
        Set<String> windowHandles = DriverManagement.getDriver().getWindowHandles();
        WebDriver newDriver = DriverManagement.getDriver().switchTo().window(DriverManagement.getDriver().getWindowHandles().toArray()[windowHandles.size() - 1].toString());
    ...
    public static void acceptAlert() {
        sleep(Constants.WAIT_SLEEP_STEP);
        DriverManagement.getDriver().switchTo().alert().accept();
    ...
    public static String getTextAlert() {
        sleep(Constants.WAIT_SLEEP_STEP);
        LogUtils.info("Get text ion alert: " + DriverManagement.getDriver().switchTo().alert().getText());
        return DriverManagement.getDriver().switchTo().alert().getText();
    }
    ...
    public static void setTextAlert(String text) {
        sleep(Constants.WAIT_SLEEP_STEP);
        DriverManagement.getDriver().switchTo().alert().sendKeys(text);
    ...
    public static boolean verifyAlertPresent(int timeOut) {
        try {
            WebDriverWait wait = new WebDriverWait(DriverManagement.getDriver(), Duration.ofSeconds(timeOut), Duration.ofMillis(500));
    ...
    public static boolean verifyEquals(Object value1, Object value2) {
        ...
        if (result == true) {
            ...
            if (ExtentTestManagement.getExtentTest() != null) {
                ExtentReportManagement.pass("Verify Equals: " + value1 + " = " + value2);
            }
        } else {
            LogUtils.info("Verify Equals: " + value1 + " != " + value2);
            if (ExtentTestManagement.getExtentTest() != null) {
                ExtentReportManagement.fail("Verify Equals: " + value1 + " != " + value2);
            }
    ...
    public static boolean verifyContains(String value1, String value2) {
        ...
        if (result == true) {
            ...
            if (ExtentTestManagement.getExtentTest() != null) {
                ExtentReportManagement.pass("Verify Contains: " + value1 + " CONTAINS " + value2);
            }
        } else {
            LogUtils.info("Verify Contains: " + value1 + " NOT CONTAINS " + value2);
            if (ExtentTestManagement.getExtentTest() != null) {
                ExtentReportManagement.fail("Verify Contains: " + value1 + " NOT CONTAINS " + value2);
            }
    ...
    public static boolean verifyTrue(Boolean condition) {
        if (condition == true) {
            ...
            if (ExtentTestManagement.getExtentTest() != null) {
                ExtentReportManagement.pass("Verify TRUE: " + condition);
            }
        } else {
            LogUtils.info("Verify TRUE: " + condition);
            if (ExtentTestManagement.getExtentTest() != null) {
                ExtentReportManagement.fail("Verify TRUE: " + condition);
            }
    ...
    public static boolean verifyElementTextEquals(By by, String text, FailureHandling flowControl) {
        ...
        if (flowControl.equals(FailureHandling.CONTINUE_ON_FAILURE)) {
            ...
            if (result == false) {
                ExtentReportManagement.fail("The actual text is '" + getTextElement(by).trim() + "' not equals '" + text.trim() + "'");
            }
        }
        if (flowControl.equals(FailureHandling.OPTIONAL)) {
            if (ExtentTestManagement.getExtentTest() != null) {
                ExtentReportManagement.warning("Verify text of an element [Equals] - " + result);
                ExtentReportManagement.warning("The actual text is '" + getTextElement(by).trim() + "' not equals expected text '" + text.trim() + "'");
            }
        }
    ...
    public static boolean verifyElementTextEquals(By by, String text) {
        ...
        if (ExtentTestManagement.getExtentTest() != null) {
            ExtentReportManagement.warning("Verify text of an element [Equals] : " + result);
            ExtentReportManagement.warning("The actual text is '" + getTextElement(by).trim() + "' not equals '" + text.trim() + "'");
        }
        addScreenshotToReport(Thread.currentThread().getStackTrace()[1].getMethodName() + "_" + DateUtils.getCurrentDateTime());
        return result;
    }
    ...
    public static boolean verifyElementTextContains(By by, String text, FailureHandling flowControl) {
        ...
        if (flowControl.equals(FailureHandling.OPTIONAL)) {
            if (ExtentTestManagement.getExtentTest() != null) {
                ExtentReportManagement.warning("Verify text of an element [Contains] - " + result);
            }
        }
    ...
    public static boolean verifyElementTextContains(By by, String text) {
        ...
        if (ExtentTestManagement.getExtentTest() != null) {
            ExtentReportManagement.info("Verify text of an element [Contains] : " + result);
        }
        addScreenshotToReport(Thread.currentThread().getStackTrace()[1].getMethodName() + "_" + DateUtils.getCurrentDateTime());
    ...
    public static boolean verifyElementClickable(By by) {
        ...
        try {
            ...
            if (ExtentTestManagement.getExtentTest() != null) {
                ExtentReportManagement.info("Verify element clickable " + by);
            }
            return true;
        } catch (Exception e) {
    ...
    public static boolean verifyElementPresent(By by) {
        ...
        try {
            ...
            if (ExtentTestManagement.getExtentTest() != null) {
                ExtentReportManagement.info("Verify element present " + by);
            }
            addScreenshotToReport(Thread.currentThread().getStackTrace()[1].getMethodName() + "_" + DateUtils.getCurrentDateTime());
            return true;
        } catch (Exception e) {
    ...
    public static void reloadPage() {
        ...
        DriverManagement.getDriver().navigate().refresh();
        waitForPageLoaded();
        LogUtils.info("Reloaded page " + DriverManagement.getDriver().getCurrentUrl());
    }
    ...
    public static WebElement highLightElement(By by) {
        ...
        if (DriverManagement.getDriver() instanceof JavascriptExecutor) {
            ((JavascriptExecutor) DriverManagement.getDriver()).executeScript("arguments[0].style.border='3px solid red'", waitForElementVisible(by));
            sleep(1);
    ...
    public static void openWebsite(String URL) {
        ...
        if (ExtentTestManagement.getExtentTest() != null) {
            ExtentReportManagement.pass("Open website with URL: " + URL);
        }
        addScreenshotToReport(Thread.currentThread().getStackTrace()[1].getMethodName() + "_" + DateUtils.getCurrentDateTime());
    ...
    public static void navigateToUrl(String URL) {
        ...
        if (ExtentTestManagement.getExtentTest() != null) {
            ExtentReportManagement.pass("Navigate to URL: " + URL);
        }
        addScreenshotToReport(Thread.currentThread().getStackTrace()[1].getMethodName() + "_" + DateUtils.getCurrentDateTime());
    ...
    public static void setText(By by, String value) {
        ...
        if (ExtentTestManagement.getExtentTest() != null) {
            ExtentReportManagement.pass("Set text " + value + " on " + by.toString());
        }
        addScreenshotToReport(Thread.currentThread().getStackTrace()[1].getMethodName() + "_" + DateUtils.getCurrentDateTime());
    }
    ...
    public static void setText(By by, String value, Keys keys) {
        ...
        if (ExtentTestManagement.getExtentTest() != null) {
            ExtentReportManagement.pass("Set text " + value + " on " + by + " and press key " + keys.name());
        }
        addScreenshotToReport(Thread.currentThread().getStackTrace()[1].getMethodName() + "_" + DateUtils.getCurrentDateTime());
    }
    ...
    public static void sendKeys(By by, Keys keys) {
        ...
        if (ExtentTestManagement.getExtentTest() != null) {
            ExtentReportManagement.pass("Press key " + keys.name() + " on element " + by);
        }
        addScreenshotToReport(Thread.currentThread().getStackTrace()[1].getMethodName() + "_" + DateUtils.getCurrentDateTime());
    }
    ...
    public static void sendKeys(Keys keys) {
        ...
        if (ExtentTestManagement.getExtentTest() != null) {
            ExtentReportManagement.pass("Press key " + keys.name() + " on keyboard");
        }
        addScreenshotToReport(Thread.currentThread().getStackTrace()[1].getMethodName() + "_" + DateUtils.getCurrentDateTime());
    }
    ...
    public static void clearText(By by) {
        ...
        if (ExtentTestManagement.getExtentTest() != null) {
            ExtentReportManagement.pass("Clear text in textbox " + by.toString());
        }
        addScreenshotToReport(Thread.currentThread().getStackTrace()[1].getMethodName() + "_" + DateUtils.getCurrentDateTime());
    }
    ...
    public static void clearAndFillText(By by, String value) {
        ...
        if (ExtentTestManagement.getExtentTest() != null) {
            ExtentReportManagement.pass("Clear and Fill " + value + " on " + by.toString());
        }
        addScreenshotToReport(Thread.currentThread().getStackTrace()[1].getMethodName() + "_" + DateUtils.getCurrentDateTime());
    }
    ...
    public static void clickElement(By by) {
        ...
        if (ExtentTestManagement.getExtentTest() != null) {
            ExtentReportManagement.pass("Clicked on the element " + by.toString());
        }
        addScreenshotToReport(Thread.currentThread().getStackTrace()[1].getMethodName() + "_" + DateUtils.getCurrentDateTime());
    }
    ...
    public static void clickElementWithJs(By by) {
        ...
        if (ExtentTestManagement.getExtentTest() != null) {
            ExtentReportManagement.pass("Click on element with JS: " + by);
        }
        addScreenshotToReport(Thread.currentThread().getStackTrace()[1].getMethodName() + "_" + DateUtils.getCurrentDateTime());
    }
    ...
    public static void clickLinkText(String linkText) {
        ...
        if (ExtentTestManagement.getExtentTest() != null) {
            ExtentReportManagement.pass("Click on link text " + linkText);
        }
        addScreenshotToReport(Thread.currentThread().getStackTrace()[1].getMethodName() + "_" + DateUtils.getCurrentDateTime());
    }
    ...
    public static void rightClickElement(By by) {
        ...
        if (ExtentTestManagement.getExtentTest() != null) {
            ExtentReportManagement.pass("Right click on element " + by);
        }
        addScreenshotToReport(Thread.currentThread().getStackTrace()[1].getMethodName() + "_" + DateUtils.getCurrentDateTime());
    }
    ...
    public static String getTextElement(By by) {
        ...
        if (ExtentTestManagement.getExtentTest() != null) {
            ExtentReportManagement.pass("Get text on element " + by);
            ExtentReportManagement.pass("The Text is: " + waitForElementVisible(by).getText().trim());
        }
    ...
    public static String getAttributeElement(By by, String attributeName) {
        smartWait();
        LogUtils.info("Get attributeName on element " + by);
        if (ExtentTestManagement.getExtentTest() != null) {
            ExtentReportManagement.pass("Get attributeName on element " + by);
            ExtentReportManagement.pass("The attributeName is: " + waitForElementVisible(by).getAttribute(attributeName));
        }
    ...
    public static String getCssValueElement(By by, String cssName) {
        ...
        LogUtils.info("Get attributeName on element " + by);
        if (ExtentTestManagement.getExtentTest() != null) {
            ExtentReportManagement.pass("Get getCssValue on element " + by);
            ExtentReportManagement.pass("The getCssValue is: " + waitForElementVisible(by).getCssValue(cssName));
        }
    ...
    public static Dimension getSizeElement(By by) {
        smartWait();
        LogUtils.info("Get element size on element " + by);
        if (ExtentTestManagement.getExtentTest() != null) {
            ExtentReportManagement.pass("Get element size on " + by);
            ExtentReportManagement.pass("The element size is: " + waitForElementVisible(by).getSize());
        }
    ...
    public static Point getLocationElement(By by) {
        smartWait();
        LogUtils.info("Get Element Location on element" + by);
        if (ExtentTestManagement.getExtentTest() != null) {
            ExtentReportManagement.pass("Get Element Location on " + by);
            ExtentReportManagement.pass("The element Element Location is: " + waitForElementVisible(by).getLocation());
        }
    ...
    public static String getTagNameElement(By by) {
        smartWait();
        LogUtils.info("Get Element TagName on element" + by);
        if (ExtentTestManagement.getExtentTest() != null) {
            ExtentReportManagement.pass("Get Element TagName on " + by);
            ExtentReportManagement.pass("The element Element TagName is: " + waitForElementVisible(by).getTagName());
        }
    ...
    public static void checkContainsValueOnTableByColumn(int column, String value, String xpathToTRtagname) {
        ...
        List<WebElement> totalRows = DriverManagement.getDriver().findElements(By.xpath(xpathToTRtagname));
        sleep(1);
        LogUtils.info("Number of results for keywords (" + value + "): " + totalRows.size());
    ...
    public static void waitForPageLoaded() {
        WebDriverWait wait = new WebDriverWait(DriverManagement.getDriver(), Duration.ofSeconds(Constants.WAIT_PAGE_LOADED), Duration.ofMillis(500));
        JavascriptExecutor js = (JavascriptExecutor) DriverManagement.getDriver();
    ...
    public static void waitForAngularLoad() {
        ...
        if (!angularReady) {
            ...
            try {
                ...
                Assert.fail("Timeout waiting for Angular load. (" + Constants.WAIT_PAGE_LOADED + "s)");
            }
        }
